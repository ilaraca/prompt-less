...
histórico + tools longas) com o pacote que a pipeline realmente monta.
  ...
  python -m src.reason.economia
  python -m src.reason.economia --runs-mes 80 --modelo gpt-4o
  python -m src.reason.economia --modelo claude-sonnet --cache-hit 0.6

  # Cenário hipotético (sem ler inputs/)
  python -m src.reason.economia --what-if --linhas 3000 --runs-mes 40

  # JSON para dashboard/CI
  python -m src.reason.economia --json
"""
...
from src.context.builder import build_context  # noqa: E402
from src.ingest import ARTIFACT_TEMPLATES, load_inputs  # noqa: E402
from src.preprocess import preprocess  # noqa: E402
from src.compress.rag_compress import compress_rag  # noqa: E402
from src.context.tokenizer import (  # noqa: E402
