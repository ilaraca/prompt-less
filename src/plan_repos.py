...
Uso:
  ...
  python -m src.plan_repos --workspace ~/dev/repos --index state/repo_index.json
  python -m src.plan_repos --spec runs/x/artifacts/canonical-spec.yaml --reviewed
"""
...
from src.repo_index import index_workspace, load_index  # noqa: E402
