...
from src.compress.doc_compress import (  # noqa: E402
    SIGNAL_RE,
    _clip,
    summarize_document_chunk,
)
from src.compress.doc_preface import (  # noqa: E402
    Section,
    build_inverted,
    parse_sections,
    tokenize,
...
from src.context.tokenizer import count_tokens, est_raw  # noqa: E402
...
def _retrieve_flat(
    ...
    *,
    ...
    from src.compress.doc_compress import build_document_chunks
