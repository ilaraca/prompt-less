...
Uso:
  python -m src.runtime.parallel_exec --plan runs/plan/implementation_plan.json
  python -m src.runtime.parallel_exec --plan … --max-concurrency 3 --out runs/parallel/
  python -m src.runtime.parallel_exec --plan … --dry-run   # só lista ondas (sem adapter)
"""
...
from src.runtime.state_store import FileStateBackend, open_state_backend  # noqa: E402
