...
Uso:
  python -m src.executors.close_loop --spec path/canonical-spec.yaml --result path/execution.json --repo path/checkout
  python -m src.executors.close_loop --spec ... --result ... --repo ... --adapter-log path/adapter-log.jsonl
  python -m src.executors.close_loop --spec ... --result ... --repo ... --attempt 1
